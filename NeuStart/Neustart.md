...
Neues file mit CMD+N
Speichern mit CMD+S als bsp.: "Readme.md"
In Atom lia eingeben um Möglichkeiten anzuzeigen
mit Liainit Basiskurs erstellen
Kurs anzeigen: Packages -> liapreview -> Toggle, shortcut cmd+s
